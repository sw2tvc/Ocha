...
import { ArrowLeft, ChevronRight, Building2, Calendar, Clock, AlertCircle } from "lucide-react";
import { useListProperties, useCreateBooking, getListPropertiesQueryKey } from "@workspace/api-client-react";
...
export default function Book() {
  ...
  const properties = propertiesData?.properties || MOCK_PROPERTIES;
    ...
    try {
      ...
      await createBookingMutation.mutateAsync({
        data: {
          ...
          scheduledAt,
          estimatedDurationHours: selectedServiceData.price / 22,
      ...
      setLocation("/bookings");
      toast({ title: "Booking sent", description: "Demo mode: booking created successfully." });
    } finally {
      ...
      <div className="max-w-md mx-auto w-full px-4 pt-5">
            ...
            <div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-3 p-4 rounded-2xl border border-dashed border-border bg-transparent text-left"
                >
        ...
        {step === 2 && (
          <div className="flex flex-col gap-5">
            ...
            <div>
              <h2 className="text-sm font-bold text-foreground mb-3">Notes (optional)</h2>
              <textarea
      ...
      <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md px-4 pb-8 pt-3 bg-background border-t border-border">
        {step < 3 ? (
          <button
            ...
            className="w-full bg-primary text-primary-foreground rounded-2xl py-4 font-bold text-sm flex items-center justify-center gap-2"
          >
